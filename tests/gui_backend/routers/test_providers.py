...
class TestProvidersEndpoints:
    ...
    def mock_provider_service(self):
        ...
        with patch('script_to_speech.gui_backend.routers.providers.provider_service') as mock:
            yield mock
    ...
    def test_get_providers_service_error(self, client: TestClient, mock_provider_service):
        """Test handling of service errors in providers endpoint."""
        # Arrange
        mock_provider_service.get_available_providers.side_effect = Exception("Provider service error")
    ...
    def test_get_specific_provider_success(self, client: TestClient, mock_provider_service):
        """Test successful retrieval of a specific provider."""
        # Arrange
        from script_to_speech.gui_backend.models import ProviderInfo, ProviderField, FieldType
    ...
    def test_get_specific_provider_not_found(self, client: TestClient, mock_provider_service):
        """Test retrieval of a non-existent provider."""
        # Arrange
        provider_id = "non_existent_provider"
        mock_provider_service.get_provider_info.side_effect = ValueError(f"Provider {provider_id} not found")
    ...
    def test_get_specific_provider_service_error(self, client: TestClient, mock_provider_service):
...
class TestProvidersInfo:
    ...
    def test_get_all_providers_info_success(self, client: TestClient, mock_provider_service):
    ...
    def test_get_all_providers_info_empty(self, client: TestClient, mock_provider_service):
    ...
    def test_get_all_providers_info_service_error(self, client: TestClient, mock_provider_service):
        """Test handling of service errors in providers info endpoint."""
        # Arrange
        mock_provider_service.get_all_providers.side_effect = Exception("Provider service error")
...
class TestProviderConfiguration:
    ...
    def test_validate_provider_config_success(self, client: TestClient, mock_provider_service):
        ...
        mock_provider_service.validate_config.assert_called_once_with(provider_id, config)

    def test_validate_provider_config_invalid(self, client: TestClient, mock_provider_service):
    ...
    def test_validate_provider_config_provider_not_found(self, client: TestClient, mock_provider_service):
        """Test config validation for non-existent provider."""
        # Arrange
        provider_id = "non_existent"
        config = {"model": "tts-1"}
        mock_provider_service.validate_config.side_effect = ValueError(f"Provider {provider_id} not found")
    ...
    def test_validate_provider_config_service_error(self, client: TestClient, mock_provider_service):
        """Test handling of service errors during config validation."""
        # Arrange
        provider_id = "openai"
        config = {"model": "tts-1"}
        mock_provider_service.validate_config.side_effect = Exception("Validation error")
