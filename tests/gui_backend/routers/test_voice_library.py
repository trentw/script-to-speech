...
class TestVoiceLibraryProviders:
    ...
    def mock_voice_library_service(self):
        ...
        patch.object(
            voice_library_service, 'search_voices'
        ) as mock_search, \
        patch.object(
            voice_library_service, 'get_voice_stats'
        ) as mock_get_stats, \
        patch.object(
            voice_library_service, 'expand_sts_id'
        ) as mock_expand:
            # Create a mock object with all the methods
            mock = type('MockService', (), {
    ...
    def test_get_voice_library_providers_success(self, client: TestClient, mock_voice_library_service):
        """Test successful retrieval of voice library providers."""
        # Arrange
        expected_providers = ["openai", "elevenlabs", "cartesia"]
        mock_voice_library_service.get_available_providers.return_value = expected_providers
    ...
    def test_get_voice_library_providers_empty(self, client: TestClient, mock_voice_library_service):
    ...
    def test_get_voice_library_providers_service_error(self, client: TestClient, mock_voice_library_service):
        """Test handling of service errors in providers endpoint."""
        # Arrange
        mock_voice_library_service.get_available_providers.side_effect = Exception("Service error")
...
class TestProviderVoices:
    ...
    def sample_voice_entries(self) -> List[VoiceEntry]:
        ...
        return [
            ...
            VoiceEntry(
                ...
                description=VoiceDescription(
                    provider_name="Echo",
                    provider_description="Clear male voice"
                )
            )
        ]

    def test_get_provider_voices_success(self, client: TestClient, mock_voice_library_service, sample_voice_entries):
        """Test successful retrieval of voices for a provider."""
        # Arrange
        provider = "openai"
        mock_voice_library_service.get_provider_voices.return_value = sample_voice_entries
        mock_voice_library_service.get_available_providers.return_value = ["openai", "elevenlabs"]
    ...
    def test_get_provider_voices_empty_provider(self, client: TestClient, mock_voice_library_service):
    ...
    def test_get_provider_voices_nonexistent_provider(self, client: TestClient, mock_voice_library_service):
    ...
    def test_get_provider_voices_service_error(self, client: TestClient, mock_voice_library_service):
        """Test handling of service errors when getting provider voices."""
        # Arrange
        provider = "openai"
        mock_voice_library_service.get_provider_voices.side_effect = Exception("Service error")
...
class TestVoiceDetails:
    ...
    def test_get_voice_details_success(self, client: TestClient, mock_voice_library_service, sample_voice_details):
        ...
        mock_voice_library_service.get_voice_details.assert_called_once_with(provider, sts_id)

    def test_get_voice_details_not_found(self, client: TestClient, mock_voice_library_service):
    ...
    def test_get_voice_details_service_error(self, client: TestClient, mock_voice_library_service):
        """Test handling of service errors when getting voice details."""
        # Arrange
        provider = "openai"
        sts_id = "alloy"
        mock_voice_library_service.get_voice_details.side_effect = Exception("Service error")
...
class TestVoiceSearch:
    ...
    def test_search_voices_by_query(self, client: TestClient, mock_voice_library_service, sample_search_results):
    ...
    def test_search_voices_by_provider(self, client: TestClient, mock_voice_library_service):
    ...
    def test_search_voices_by_gender(self, client: TestClient, mock_voice_library_service, sample_search_results):
    ...
    def test_search_voices_by_tags(self, client: TestClient, mock_voice_library_service):
        ...
        # Act
        response = client.get(f"/api/voice-library/search?tags={tags[0]}&tags={tags[1]}")
    ...
    def test_search_voices_multiple_filters(self, client: TestClient, mock_voice_library_service):
        ...
        # Act
        response = client.get(f"/api/voice-library/search?query={query}&provider={provider}&gender={gender}")
    ...
    def test_search_voices_no_results(self, client: TestClient, mock_voice_library_service):
    ...
    def test_search_voices_no_filters(self, client: TestClient, mock_voice_library_service, sample_search_results):
    ...
    def test_search_voices_service_error(self, client: TestClient, mock_voice_library_service):
...
class TestVoiceLibraryStats:
    ...
    def test_get_voice_library_stats_success(self, client: TestClient, mock_voice_library_service):
    ...
    def test_get_voice_library_stats_empty(self, client: TestClient, mock_voice_library_service):
    ...
    def test_get_voice_library_stats_service_error(self, client: TestClient, mock_voice_library_service):
        """Test handling of service errors when getting voice library stats."""
        # Arrange
        mock_voice_library_service.get_voice_stats.side_effect = Exception("Stats error")
...
class TestStsIdExpansion:
    ...
    def test_expand_sts_id_success(self, client: TestClient, mock_voice_library_service):
        ...
        mock_voice_library_service.expand_sts_id.assert_called_once_with(provider, sts_id)

    def test_expand_sts_id_not_found(self, client: TestClient, mock_voice_library_service):
    ...
    def test_expand_sts_id_service_error(self, client: TestClient, mock_voice_library_service):
        """Test handling of service errors during sts_id expansion."""
        # Arrange
        provider = "openai"
        sts_id = "alloy"
        mock_voice_library_service.expand_sts_id.side_effect = Exception("Expansion error")
    ...
    def test_expand_sts_id_empty_config(self, client: TestClient, mock_voice_library_service):
