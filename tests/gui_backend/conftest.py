...
def mock_screenplay_service() -> Generator[MagicMock, None, None]:
    ...
    with patch(
        "script_to_speech.gui_backend.routers.screenplay.screenplay_service"
    ) as mock:
...
def mock_asyncio_create_task() -> Generator[AsyncMock, None, None]:
    ...
    with patch(
        "script_to_speech.gui_backend.services.screenplay_service.ScreenplayService._process_parsing_task",
