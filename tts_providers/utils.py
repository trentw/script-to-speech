    ...
    try:
        ...
        if existing_yaml_path:
            ...
            base_name = os.path.splitext(
                os.path.basename(existing_yaml_path))[0]
...
if __name__ == "__main__":
    ...
    generate_parser = subparsers.add_parser('generate',
                                            help='Generate a YAML voice configuration template')
    generate_parser.add_argument(
        'input_json',
        help='Path to input JSON chunks file')
    generate_parser.add_argument(
        '--provider',
    ...
    populate_parser = subparsers.add_parser('populate',
                                            help='Populate provider-specific fields in existing YAML')
