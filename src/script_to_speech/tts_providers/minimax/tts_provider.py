...
class MinimaxTTSProvider(StatelessTTSProviderBase):
    ...
    VALID_VOICE_IDS: Set[str] = {
        ...
        "Eglish_horror_movie_narrator_vv1",
        ...
        "English_energetic_caster_vv1",
        "moss_audio_62ca20b0-7380-11f0-99be-fe40dd2a5fe8",
        "English_energetic_reporter_vv1",
        "conversational_female_1_v1",
        "English_engaging_instructor_vv2",
        "conversational_female_2_v1",
        "English_exciting_actor_vv1",
        "socialmedia_female_1_v1",
        "English_expressive_host__vv1",
        "BritishChild_male_1_v1",
        "English_gentle_storyteller_vv1",
        "BritishChild_female_1_v1",
        "English_instructive_professor_vv1",
        "English_male_lecturer_vv1",
        "English_matured_host_vv1",
        "English_movie_commentato_vv1",
        "English_nursery_teacher_vv2",
        "English_resonant_storyteller_vv2",
        "Enlish_analytical_scholar_vv1",
        "Enlish_confident_streamer_vv1",
        "Enlish_engaging_podcaster_vv1",
        "Enlish_podcast_host_vv1",
        "ttv-voice-2025062518302725-Nrot8sG4",
        "ttv-voice-2025062517241625-ukalfUbZ",
        "ttv-voice-2025062519422425-GrH4Wv1A",
    }
